...
public class RenderRedwire extends RenderWiring {
   ...
   public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float partialTicks) {
      ...
      if (wiring.CoverSides > 0) {
         ...
         super.context.readGlobalLights(world, wiring.xCoord, wiring.yCoord, wiring.zCoord);
      ...
      if (metadata != 0) {
         ...
         switch(metadata) {
            case 1:
               ...
               super.context.setTint(0.3F + 0.7F * ((float)tx.PowerState / 255.0F), 0.0F, 0.0F);
            ...
            case 2:
               ...
               this.setSideIcon(
                  ...
                  tx1.PowerState > 0 ? RedPowerWiring.insulatedFaceOn[wiring.Metadata] : RedPowerWiring.insulatedFaceOff[wiring.Metadata],
                  RedPowerWiring.insulatedTop[wiring.Metadata]
               );
            ...
            case 3:
               ...
               if (wiring.Metadata == 0) {
                  ...
                  this.setSideIcon(
                     RedPowerWiring.bundledColTop[wiring.Metadata - 1], RedPowerWiring.bundledColFace[wiring.Metadata - 1], RedPowerWiring.bundledTop
                  );
               }
         ...
         if ((metadata == 1 || metadata == 3 || metadata == 5) && (wiring.ConSides & 64) != 0) {
            ...
            this.renderCenterBlock(cons >> 24 | wiring.ConSides & 63, CoverRenderer.coverIcons[wiring.CenterPost], icon);
         }
      }
   ...
   public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
      ...
      switch(bid) {
         ...
         case 30:
            ...
            super.context.setSize(0.0, 0.0, (double)(0.5F - th), 1.0, 1.0, (double)(0.5F + th));
         ...
         case 38:
            ...
            super.context.setIcon(CoverRenderer.coverIcons[meta]);
            super.context.setSize((double)(0.5F - th), (double)(0.5F - th), (double)(0.5F - th), (double)(0.5F + th), (double)(0.5F + th), (double)(0.5F + th));
            super.context.calcBounds();
            tess.startDrawingQuads();
            super.context.useNormal = true;
            super.context.renderFaces(63);
         ...
         case 42:
            ...
            super.context.setIcon(CoverRenderer.coverIcons[meta]);
            super.context.setSize((double)(0.5F - th), 0.0, (double)(0.5F - th), (double)(0.5F + th), 1.0, (double)(0.5F + th));
            super.context.calcBounds();
            tess.startDrawingQuads();
            super.context.useNormal = true;
            super.context.renderFaces(63);
         ...
         case 34:
            ...
            tess.startDrawingQuads();
            super.context.useNormal = true;
            super.context.renderBox(63, 0.0, 0.0, (double)(0.5F - th), 0.25, 1.0, (double)(0.5F + th));
            super.context.renderBox(63, 0.75, 0.0, (double)(0.5F - th), 1.0, 1.0, (double)(0.5F + th));
            super.context.renderBox(15, 0.25, 0.0, (double)(0.5F - th), 0.75, 0.25, (double)(0.5F + th));
            super.context.renderBox(15, 0.25, 0.75, (double)(0.5F - th), 0.75, 1.0, (double)(0.5F + th));
            super.context.useNormal = false;
            tess.draw();
            return;
         case 43:
         ...
         case 45:
            ...
            super.context.setIcon(CoverRenderer.coverIcons[meta]);
            super.context.setSize((double)(0.5F - th), 0.125, (double)(0.5F - th), (double)(0.5F + th), 0.875, (double)(0.5F + th));
            super.context.calcBounds();
            tess.startDrawingQuads();
            super.context.useNormal = true;
            super.context.renderFaces(63);
            super.context.setSize((double)(0.45F - th), 0.0, (double)(0.45F - th), (double)(0.55F + th), 0.125, (double)(0.55F + th));
            super.context.calcBounds();
            super.context.renderFaces(63);
            super.context.setSize((double)(0.45F - th), 0.875, (double)(0.45F - th), (double)(0.55F + th), 1.0, (double)(0.55F + th));
            super.context.calcBounds();
            super.context.renderFaces(63);
            super.context.useNormal = false;
            tess.draw();
