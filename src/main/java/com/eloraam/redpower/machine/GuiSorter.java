...
public class GuiSorter extends GuiContainer {
   ...
   private static final ResourceLocation res = new ResourceLocation("rpmachine", "textures/gui/sortmachine.png");
   ...
   private void sendMode() {
      if (super.mc.theWorld.isRemote) {
         RedPowerCore.sendPacketToServer(new PacketGuiEvent.GuiMessageEvent(1, super.inventorySlots.windowId, this.sorter.mode));
      }
   ...
   private void sendAutoMode() {
      if (super.mc.theWorld.isRemote) {
         RedPowerCore.sendPacketToServer(new PacketGuiEvent.GuiMessageEvent(4, super.inventorySlots.windowId, this.sorter.automode));
      }
   ...
   private void sendColor(int n) {
      if (super.mc.theWorld.isRemote) {
         RedPowerCore.sendPacketToServer(new PacketGuiEvent.GuiMessageEvent(2, super.inventorySlots.windowId, (byte)n, this.sorter.colors[n]));
      }
   ...
   private void sendDefColor() {
      if (super.mc.theWorld.isRemote) {
         RedPowerCore.sendPacketToServer(new PacketGuiEvent.GuiMessageEvent(3, super.inventorySlots.windowId, this.sorter.defcolor));
      }
