...
@Mod(
    ...
    version = "1.4.3.1",
    dependencies
    = "required-after:NotEnoughItems;after:RedPowerBase;after:RedPowerCompat;after:RedPowerControl;after:RedPowerCore;after:RedPowerLighting;after:RedPowerLogic;after:RedPowerMachine;after:RedPowerWiring;after:RedPowerWorld"
)
public class RedPowerNEIPlugin {
            ...
            if (Loader.isModLoaded("NotEnoughItems")) {
                ...
                if (base) {
                    ...
                    API.registerGuiOverlayHandler(
                        GuiAlloyFurnace.class, new AlloyFurnaceOverlayHandler(), "alloy"
                    );
                    API.registerGuiOverlayHandler(
                        GuiAdvBench.class, new DefaultOverlayHandler(23, 12), "crafting"
                    );
                ...
                FMLCommonHandler.instance().getFMLLogger().warn(
                    "[RedPowerNEIPlugin] No NEI detected, disabling..."
                );
            }
        }
    }
        ...
        if (base) {
            ...
            for (int i = 0; i < 256; ++i) {
                ...
                if (!name.endsWith("Unnamed") && !name.endsWith("null")) {
                    ...
                    this.validMicroTypes.add(
                        new RedPowerNEIPlugin.ItemRange(micro, startRange, i - 1)
                    );
                    startRange = -1;
                }
            }
    ...
    private void registerMicroSet(String RPName, int microID) {
        ...
        for (RedPowerNEIPlugin.ItemRange type : this.validMicroTypes) {
            set.with((ItemStack[]) IntStream.rangeClosed(type.start, type.end)
