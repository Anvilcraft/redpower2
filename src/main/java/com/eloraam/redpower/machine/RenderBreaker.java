...
public class RenderBreaker extends RenderCustomBlock {
    ...
    public void renderTileEntityAt(
        ...
        IIcon front = breaker.Active ? RedPowerMachine.breakerFrontOn
                                     : RedPowerMachine.breakerFront;
        IIcon side = breaker.Active ? RedPowerMachine.breakerSideOn
                                    : RedPowerMachine.breakerSide;
        this.context.setPos(x, y, z);
        this.context.readGlobalLights(
            world, breaker.xCoord, breaker.yCoord, breaker.zCoord
        );
