...
public class TileWindTurbine extends TileMachine implements IInventory, IBluePowerConnectable, IMultiblock {
   ...
   public void onTileTick() {
      ...
      this.windSpeed = (int)(10000.0 * EnvironLib.getWindSpeed(super.worldObj, new WorldCoord(this)));
      if (this.hasBlades) {
         switch(this.windmillType) {
            case 1:
   ...
   public boolean onBlockActivated(EntityPlayer player) {
      if (player.isSneaking()) {
         ...
         if (!super.worldObj.isRemote) {
            player.openGui(RedPowerMachine.instance, 15, super.worldObj, super.xCoord, super.yCoord, super.zCoord);
         }
