...
public class RenderFrameTube extends RenderTube {
   ...
   public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float partialTicks) {
      ...
      int lv = world.getLightBrightnessForSkyBlocks(frameTube.xCoord, frameTube.yCoord, frameTube.zCoord, 0);
      ...
      super.context.readGlobalLights(world, frameTube.xCoord, frameTube.yCoord, frameTube.zCoord);
      ...
      int conn = TubeLib.getConnections(world, frameTube.xCoord, frameTube.yCoord, frameTube.zCoord);
      ...
      if (frameTube.paintColor > 0) {
         ...
         super.context.setTint((float)(pcolor >> 16) / 255.0F, (float)(pcolor >> 8 & 0xFF) / 255.0F, (float)(pcolor & 0xFF) / 255.0F);
