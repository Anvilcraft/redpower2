...
public class TileLogicArray extends TileLogic implements IRedPowerWiring {
   ...
   public void updateCurrentStrength() {
      this.PowerVal2 = (short)RedPowerLib.updateBlockCurrentStrength(
         super.worldObj, this, super.xCoord, super.yCoord, super.zCoord, RedPowerLib.mapRotToCon(5, super.Rotation), 1
      );
      this.PowerVal1 = (short)RedPowerLib.updateBlockCurrentStrength(
         super.worldObj, this, super.xCoord, super.yCoord, super.zCoord, RedPowerLib.mapRotToCon(10, super.Rotation), 1
      );
      this.updateBlock();
   }
      ...
      return ch != 0
         ...
         : (
            (RedPowerLib.mapRotToCon(5, super.Rotation) & cons) > 0
               ? this.PowerVal2
               : ((RedPowerLib.mapRotToCon(10, super.Rotation) & cons) > 0 ? this.PowerVal1 : -1)
         );
   }
   ...
   public int scanPoweringStrength(int cons, int ch) {
      if (ch != 0) {
         ...
         return (r1 & cons) > 0
            ? (super.Powered ? 255 : (RedPowerLib.isPowered(super.worldObj, super.xCoord, super.yCoord, super.zCoord, r1 & cons, 0) ? 255 : 0))
            : ((r2 & cons) > 0 ? (RedPowerLib.isPowered(super.worldObj, super.xCoord, super.yCoord, super.zCoord, r2 & cons, 0) ? 255 : 0) : 0);
      }
   }
