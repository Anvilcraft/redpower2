...
public class GuiCounter extends GuiContainer {
   ...
   public void changeCountMax(int cc) {
      ...
      if (!super.mc.theWorld.isRemote) {
         ...
         RedPowerCore.sendPacketToServer(new PacketGuiEvent.GuiMessageEvent(1, super.inventorySlots.windowId, i));
      }
   ...
   public void changeInc(int cc) {
      ...
      if (!super.mc.theWorld.isRemote) {
         ...
         RedPowerCore.sendPacketToServer(new PacketGuiEvent.GuiMessageEvent(2, super.inventorySlots.windowId, i));
      }
   ...
   public void changeDec(int cc) {
      ...
      if (!super.mc.theWorld.isRemote) {
         ...
         RedPowerCore.sendPacketToServer(new PacketGuiEvent.GuiMessageEvent(3, super.inventorySlots.windowId, i));
      }
