...
public class TileFrame extends TileCoverable implements IFrameLink, IFrameSupport {
   ...
   public void onHarvestPart(EntityPlayer player, int part, boolean willHarvest) {
      if (part == 29) {
         if (willHarvest) {
            CoreLib.dropItem(super.worldObj, super.xCoord, super.yCoord, super.zCoord, new ItemStack(RedPowerMachine.blockFrame, 1));
         }
   ...
   public void replaceWithCovers() {
      ...
      TileExtended te = CoreLib.getTileEntity(super.worldObj, super.xCoord, super.yCoord, super.zCoord, TileExtended.class);
      if (te != null) {
         te.Owner = owner;
      }
