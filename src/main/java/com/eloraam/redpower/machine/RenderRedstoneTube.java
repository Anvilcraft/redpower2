...
public class RenderRedstoneTube extends RenderTube {
   ...
   public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float partialTicks) {
      ...
      int lv = world.getLightBrightnessForSkyBlocks(redstoneTube.xCoord, redstoneTube.yCoord, redstoneTube.zCoord, 0);
      ...
      if (redstoneTube.CoverSides > 0) {
         super.context.readGlobalLights(world, redstoneTube.xCoord, redstoneTube.yCoord, redstoneTube.zCoord);
         this.renderCovers(redstoneTube.CoverSides, redstoneTube.Covers);
      }

      int cons1 = TubeLib.getConnections(world, redstoneTube.xCoord, redstoneTube.yCoord, redstoneTube.zCoord) | redstoneTube.getConnectionMask() >> 24;
