...
public class TileAccel
    extends TileMachinePanel implements IBluePowerConnectable, ITubeFlow {
    TubeFlow flow = new TubeFlow() {
        ...
        public boolean schedule(TubeItem item, TubeFlow.TubeScheduleContext context) {
            ...
            item.power = 0;
            if ((item.side == TileAccel.super.Rotation
                     && (TileAccel.this.conCache & 2) > 0
                 || item.side == (TileAccel.super.Rotation ^ 1)
    ...
    public void recache() {
        if (this.conCache < 0) {
            ...
            ITubeConnectable fw = CoreLib.getTileEntity(
                super.worldObj, wc.coordStep(super.Rotation), ITubeConnectable.class
            );
            ITubeConnectable bw = CoreLib.getTileEntity(
                super.worldObj, wc.coordStep(super.Rotation ^ 1), ITubeConnectable.class
            );
            this.conCache = 0;
            if (fw != null) {
