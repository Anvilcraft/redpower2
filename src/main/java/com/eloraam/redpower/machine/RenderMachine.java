...
public class RenderMachine extends RenderCustomBlock {
   ...
   public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float partialTicks) {
      ...
      this.context.readGlobalLights(world, machine.xCoord, machine.yCoord, machine.zCoord);
         ...
         switch(metadata) {
            case 0:
               this.context
                  .setIcon(
                     ...
                     machine.Active ? RedPowerMachine.deployerFrontOn : RedPowerMachine.deployerFront,
            ...
            default: { //TODO: WTF?
               IIcon side = metadata == 3
                  ? (machine.Active ? RedPowerMachine.filterSideOn : RedPowerMachine.filterSide)
                  : (machine.Active ? RedPowerMachine.transposerSideOn : RedPowerMachine.transposerSide);
               this.context.setIcon(RedPowerMachine.breakerBack, RedPowerMachine.transposerFront, side, side, side, side);
               break;
            }
            case 4: {
               IIcon alt = machine.Active ? RedPowerMachine.detectorSideAltOn : RedPowerMachine.detectorSideAlt;
               IIcon side;
               if (machine.Charged) {
            ...
            case 5: {
               IIcon side;
               if (machine.Charged) {
                  side = machine.Active ? RedPowerMachine.sorterSideChargedOn : RedPowerMachine.sorterSideCharged;
               } else {
                  side = machine.Active ? RedPowerMachine.sorterSideOn : RedPowerMachine.sorterSide;
               }

               this.context
                  .setIcon(
                     machine.Charged ? (machine.Active ? RedPowerMachine.sorterBackChargedOn : RedPowerMachine.sorterBackCharged) : RedPowerMachine.sorterBack,
            ...
            case 8: {
               IIcon side;
               if (machine.Charged) {
                  side = machine.Active ? RedPowerMachine.retrieverSideChargedOn : RedPowerMachine.retrieverSideCharged;
               } else {
                  side = machine.Active ? RedPowerMachine.retrieverSideOn : RedPowerMachine.retrieverSide;
               }

               this.context.setIcon(RedPowerMachine.retrieverBack, RedPowerMachine.retrieverFront, side, side, side, side);
               break;
            }
            case 10: {
               IIcon alt = machine.Active ? RedPowerMachine.regulatorSideAltCharged : RedPowerMachine.regulatorSideAlt;
               IIcon side;
               if (machine.Powered) {
            ...
            case 12:
               this.context
                  .setIcon(
                     ...
                     machine.Active ? RedPowerMachine.igniterFrontOn : RedPowerMachine.igniterFront,
            ...
            case 13:
               this.context
                  .setIcon(
                     machine.Active ? RedPowerMachine.assemblerBackOn : RedPowerMachine.assemblerBack,
                     machine.Active ? RedPowerMachine.assemblerFrontOn : RedPowerMachine.assemblerFront,
               ...
               break;
            case 14: {
               IIcon side = machine.Active ? RedPowerMachine.ejectorSideOn : RedPowerMachine.ejectorSide;
               this.context
                  .setIcon(RedPowerMachine.breakerBack, RedPowerMachine.bufferFront, side, side, RedPowerMachine.relaySideAlt, RedPowerMachine.relaySideAlt);
               break;
            }
            case 15: {
               IIcon side = machine.Active ? RedPowerMachine.relaySideOn : RedPowerMachine.relaySide;
               this.context
                  .setIcon(RedPowerMachine.breakerBack, RedPowerMachine.bufferFront, side, side, RedPowerMachine.relaySideAlt, RedPowerMachine.relaySideAlt);
            }
         }
         ...
         switch(metadata) {
            case 0: {
               IIcon side = machine.Charged
                  ? (machine.Active ? RedPowerMachine.sortronSideChargedOn : RedPowerMachine.sortronSideCharged)
                  : (machine.Active ? RedPowerMachine.sortronSideOn : RedPowerMachine.sortronSide);
               IIcon alt = machine.Charged ? RedPowerMachine.sortronSideAltCharged : RedPowerMachine.sortronSideAlt;
               this.context.setIcon(RedPowerMachine.sortronBack, RedPowerMachine.sortronFront, alt, alt, side, side);
               break;
            }
            case 1: {
               IIcon side = (machine.Charged ? RedPowerMachine.managerSideCharged : RedPowerMachine.managerSide)[(machine.Active ? 1 : 0)
