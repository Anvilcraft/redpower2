...
public class TileFrameMoving extends TileMultipart implements IFrameLink {
   private TileFrameMoving.FrameBlockAccess frameBlockAccess = new TileFrameMoving.FrameBlockAccess();
   public int motorX;
   public int motorY;
   public int motorZ;
   ...
   public void setPartBounds(BlockMultipart block, int part) {
      TileMotor tm = CoreLib.getTileEntity(super.worldObj, this.motorX, this.motorY, this.motorZ, TileMotor.class);
      if (tm != null) {
   ...
   private AxisAlignedBB getAABB(int dir, float dist) {
      AxisAlignedBB aabb = AxisAlignedBB.getBoundingBox(
         (double)super.xCoord, (double)super.yCoord, (double)super.zCoord, (double)(super.xCoord + 1), (double)(super.yCoord + 1), (double)(super.zCoord + 1)
      );
      switch(dir) {
         case 0:
   ...
   void pushEntities(TileMotor tm) {
      ...
      for(Entity ent : new ArrayList<Entity>(super.worldObj.getEntitiesWithinAABBExcludingEntity(null, aabb))) {
   ...
   private class FrameBlockAccess implements IBlockAccess {
      ...
      private TileFrameMoving getFrame(int x, int y, int z) {
         TileFrameMoving tfm = CoreLib.getTileEntity(TileFrameMoving.this.worldObj, x, y, z, TileFrameMoving.class);
         return tfm == null
            ? null
            : (tfm.motorX == TileFrameMoving.this.motorX && tfm.motorY == TileFrameMoving.this.motorY && tfm.motorZ == TileFrameMoving.this.motorZ ? tfm : null);
      }
      ...
      public boolean isSideSolid(int x, int y, int z, ForgeDirection side, boolean _default) {
         if (x >= -30000000 && z >= -30000000 && x < 30000000 && z < 30000000) {
            Chunk chunk = TileFrameMoving.this.worldObj.getChunkProvider().provideChunk(x >> 4, z >> 4);
