...
public class RenderPipe extends RenderCovers {
   ...
   public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float partialTicks) {
      ...
      if (fcl != null && lvl > 0) {
         ...
         int lv = world.getLightBrightnessForSkyBlocks(pipe.xCoord, pipe.yCoord, pipe.zCoord, 0);
         GL11.glEnable(3042);
         ...
         if ((sides & 3) > 0) {
            ...
            float n = 0.124F * lvn;
            super.context.renderBox(60, (double)(0.5F - n), (double)y1, (double)(0.5F - n), (double)(0.5F + n), (double)y2, (double)(0.5F + n));
         }
         ...
         if ((sides & 12) > 0) {
            ...
            float n = 0.248F * lvn;
            super.context.renderBox(51, 0.376F, 0.376F, (double)z1, 0.624F, (double)(0.376F + n), (double)z2);
         }
         ...
         if ((sides & 48) > 0) {
            ...
            float n = 0.248F * lvn;
            super.context.renderBox(15, (double)x1, 0.376F, 0.376F, (double)x2, (double)(0.376F + n), 0.624F);
         }
