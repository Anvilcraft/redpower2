...
public abstract class TileWiring extends TileCovered implements IWiring {
   ...
   public boolean refreshBlockSupport() {
      ...
      for(int var3 = 0; var3 < 6; ++var3) {
         if ((this.ConSides & 1 << var3) != 0 && (all || !RedPowerLib.canSupportWire(super.worldObj, super.xCoord, super.yCoord, super.zCoord, var3))) {
            this.uncache();
            CoreLib.markBlockDirty(super.worldObj, super.xCoord, super.yCoord, super.zCoord);
            CoreLib.dropItem(
               super.worldObj, super.xCoord, super.yCoord, super.zCoord, new ItemStack(RedPowerBase.blockMicro, 1, this.getExtendedID() * 256 + this.Metadata)
            );
   ...
   public float getPartStrength(EntityPlayer player, int part) {
      ...
      return part == 29 && (this.ConSides & 64) > 0
         ...
         : ((this.ConSides & 1 << part) > 0 ? player.getBreakSpeed(bl, false, 0) / (bl.getHardness() * 30.0F) : super.getPartStrength(player, part));
   }
