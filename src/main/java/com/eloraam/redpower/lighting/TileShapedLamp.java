...
public class TileShapedLamp extends TileExtended implements IFrameSupport, IConnectable {
   ...
   public void onBlockNeighborChange(Block block) {
      ...
      if (RedPowerLib.isPowered(super.worldObj, super.xCoord, super.yCoord, super.zCoord, mask & 16777215, mask >> 24)) {
         if (this.Powered) {
            return;
         }
   ...
   public void addHarvestContents(List<ItemStack> ist) {
      ItemStack is = new ItemStack(this.getBlockType(), 1, (this.Style << 5) + (this.Inverted ? 16 : 0) + this.Color);
      ist.add(is);
   }
