...
public class TilePipe extends TileCovered implements IPipeConnectable {
   ...
   public void updateEntity() {
      ...
      if (!super.worldObj.isRemote) {
         ...
         PipeLib.movePipeLiquid(super.worldObj, this, new WorldCoord(this), this.ConCache);
         this.markDirty();
   ...
   public void cacheCon() {
      if (this.ConCache < 0) {
         this.ConCache = PipeLib.getConnections(super.worldObj, super.xCoord, super.yCoord, super.zCoord);
      }
   ...
   public void cacheFlange() {
      if (this.Flanges < 0) {
         ...
         this.Flanges |= PipeLib.getFlanges(super.worldObj, new WorldCoord(this), this.ConCache);
      }
   ...
   public float getPartStrength(EntityPlayer player, int part) {
      ...
      return part == 29
         ? player.getBreakSpeed(bl, false, 0, super.xCoord, super.yCoord, super.zCoord) / (bl.getHardness() * 30.0F)
